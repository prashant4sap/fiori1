		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Test Fiori CICD",
									"targetURL": "#TestFioriCICD-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"TestFioriCICD-display": {
								"semanticObject": "TestFioriCICD",
								"action": "display",
								"description": "Test Fiori CICD",
								"title": "Test Fiori CICD",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.pm.fiori1",
									"url": sap.ui.require.toUrl("com/pm/fiori1")
								}
							}
						}
					}
